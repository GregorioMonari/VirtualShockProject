...
public class VshVirtualMachine {
    ...
    public String step() throws Exception {
        ...
        switch (cop){
            ...
            case 21: rf[decode.getRs2FromIr(ir)]=memory[a+decode.getImmediateConst(ir)]=b;break;
            //JUMP
            ...
            case 26: if(a==0) pc=decode.getImmediateConst(ir);break;
            case 27: if(a!=0) pc=decode.getImmediateConst(ir);break;
            //CONFRONTO - REGISTER
            ...
            case 40:
                ...
                memory[rf[30]]=rf[b];//poi pusho b in r[30]
                break;
            case 41:
