...
export default class NumberConversionManager{
    constructor(){
    ...
    hex2bin(n:string,size:number):string{
        var clean="";
    ...
    dec2binSigned(decimal:number,size:number){
        if(decimal<0){
            var mod=decimal*-1
    ...
    dec2binUnsigned(decimal:number,size:number){
